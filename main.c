...
void shifting_background() {
  for (int i = 0; i < 1000; i++) {
    ...
    draw_background(freq_x_1, freq_y_1, offset_x_1, offset_y_1, (color){255, 0, 255, 255});
    draw_background(freq_x_2, freq_y_2, offset_x_2, offset_y_2, (color){0, 150, 255, 100});
    draw_background(freq_y_2, freq_x_1 * .9, offset_y_2, offset_x_1, (color){0, 50, 255, 70});
